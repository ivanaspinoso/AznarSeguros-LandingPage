...
const AgricolaService = () => {
  return (
    <>
      <Navigation />
      <div id="agricola-service" style={{ backgroundColor: "#f6f6f6", padding: "50px 0", marginTop: "80px", minHeight: "100vh" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", paddingLeft: "5rem", paddingRight: "5rem" }}>
          {/* <div style={{ display: "flex", justifyContent: "center", marginBottom: "30px" }}>
            <img src="path_to_image.jpg" style={{ maxWidth: "100%", height: "auto" }} alt="Agrícola" />
          </div> */}
          ...
          <section style={{ marginBottom: "30px" }}>
            ...
            <h3 style={{ fontSize: "1.5rem", fontWeight: "600", marginBottom: "10px" }}>Adicional sin costo</h3>
            <ul style={{ paddingLeft: "20px", listStyle: "disc", marginBottom: "20px" }}>
              <li>Incendio y Resiembra</li>
            </ul>

            <h3 style={{ fontSize: "1.5rem", fontWeight: "600", marginBottom: "10px" }}>Cobertura adicional con costo</h3>
          ...
          {/* Áreas de cobertura */}
          <section style={{ marginBottom: "30px" }}>
            <h2 style={{ fontSize: "2rem", fontWeight: "600", marginBottom: "20px", color: "#a94442" }}>Áreas de cobertura</h2>
            <ul style={{ paddingLeft: "20px", listStyle: "disc", marginBottom: "20px" }}>
              <li>Buenos Aires</li>
              <li>Córdoba</li>
              <li>Corrientes</li>
          ...
          {/* Otros beneficios */}
          <section style={{ marginBottom: "30px" }}>
            <h2 style={{ fontSize: "2rem", fontWeight: "600", marginBottom: "20px", color: "#a94442" }}>Otros beneficios</h2>
            <ul style={{ paddingLeft: "20px", listStyle: "disc", marginBottom: "20px" }}>
          ...
          {/* Cultivos asegurados */}
          <section>
            <h2 style={{ fontSize: "2rem", fontWeight: "600", marginBottom: "20px", color: "#a94442" }}>Cultivos asegurados</h2>
            <ul style={{ paddingLeft: "20px", listStyle: "disc" }}>
              <li>Algodón</li>
              <li>Arveja</li>
              <li>Arroz</li>
